...
function Survival:precombat()
    ...
    if not MaxDps:CheckTrinketNames('HouseofCards') and (MaxDps:CheckTrinketNames('HouseofCards') or not MaxDps:HasOnUseEffect('14') or MaxDps:HasOnUseEffect('13') and (not MaxDps:HasOnUseEffect('14') or MaxDps:CheckTrinketCooldown('14').duration <MaxDps:CheckTrinketCooldown('13').duration or 0 <0 or 0 == 0 and MaxDps:CheckTrinketCooldown('14').duration == MaxDps:CheckTrinketCooldown('13').duration) or not MaxDps:HasOnUseEffect('13') and (not MaxDps:HasOnUseEffect('14') and (MaxDps:CheckTrinketCooldown('14').duration <MaxDps:CheckTrinketCooldown('13').duration or 0 <0 or 0 == 0 and MaxDps:CheckTrinketCooldown('14').duration == MaxDps:CheckTrinketCooldown('13').duration))) then
